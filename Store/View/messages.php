...
<body>
	<div class="header">
		...
		<select class="sel top2" onchange="location = this.value;">
					...
					<option value="../View/messages.php?lang=hu"><?php echo $lang['hun']?></option>
					<option value="../View/messages.php?lang=en"><?php echo $lang['eng']?></option>
					<option value="../View/messages.php?lang=de"><?php echo $lang['ger']?></option>
				</select><br>
			...
			<tbody>
				<?php 
    				...
    				$result=mysqli_query($conn,$query);
   						...
   						if (!$result) {
   							echo "Önnek nincs egyetlen üzenete sem!";   	
   						}
				?>
			</tbody>
		</table>
