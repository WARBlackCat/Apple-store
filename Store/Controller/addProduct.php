...
<head>
	...
	<title><?php echo $lang['addprod']?></title>
<style type="text/css">
.content {
	position: relative;
...
<body>
	...
	<div class="content">
		<h5><?php echo $lang['addprod']?></h5>
		<form action="" method="POST">
			Modell <br>
			<input type="text" name="modell" required /><br>
			<?php echo $lang['price']?> <br>
			<input type="number" name="price" min="100000" required /><br>
			<?php echo $lang['image']?> <br>
			<input type="file" name="image" required /><br>
			<input type="submit" name="sbmt" value="<?php echo $lang['upload']?>" class="btn btn2" />
		</form>
	</div>
	<?php 
		...
		if (isset($_POST['sbmt'])) {
			...
			$query = "INSERT INTO products (Name, Image, Price) VALUES ('$modell', '$image', '$price')";
			mysqli_query($conn, $query);
			echo "<script>alert('Sikeresen hozzáadta a(z) ".$modell." nevű terméket!')</script>";
