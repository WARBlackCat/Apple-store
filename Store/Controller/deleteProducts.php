...
<head>
	...
	<title><?php echo $lang['delprod']?></title>
<style type="text/css">
.content {
	position: relative;
...
<body>
	<div class="header">
		...
		<select class="sel top2" onchange="location = this.value;">
					...
					<option value="../Controller/deleteProducts.php?lang=hu"><?php echo $lang['hun']?></option>
					<option value="../Controller/deleteProducts.php?lang=en"><?php echo $lang['eng']?></option>
					<option value="../Controller/deleteProducts.php?lang=de"><?php echo $lang['ger']?></option>
				</select><br>
				...
				<?php 
    				...
    				$result=mysqli_query($conn,$query);
   						while ($row=mysqli_fetch_array($result)) {
   							...
   							echo "</td>";
   							echo "<td>";
   							echo '<img class="img" src = "../Model/Images/'.$row["Image"].'">';
   							echo "</td>";
   							echo "<td>";
   						...
   						if (!$result) {
   							echo "<h3>Nincs egyetlen terméke sem!</h3>";
   						}
				?>
			</tbody>
		</table>
	...
	if (isset($_POST['sbmt'])) {
		...
		echo "<script>confirm('Biztos, hogy törli a(z) ".$modell." nevű terméket?')</script>";
		echo '<script>window.location="../Controller/deleteProducts.php"</script>';
	}
